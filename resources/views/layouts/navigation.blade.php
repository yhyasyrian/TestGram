    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    <div class="flex flex-row gap-x-2 me-2">
                        <a href="{{route('home')}}"><x-icon-house /></a>
                        <a href="{{route('explorer')}}"><x-icon-ompass /></a>
                        <a href="{{route('post.create')}}"><x-icon-plus-square /></a>
                    </div>
                @endauth
